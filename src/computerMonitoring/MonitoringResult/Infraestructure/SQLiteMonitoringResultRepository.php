...
class SQLiteMonitoringResultRepository implements  MonitoringResultRepository
{
    ...
    /**
     * SQLiteMonitoringResultRepository constructor.
     * @param ConnectionRepository $connectionRepository
     */
    public function __construct(ConnectionRepository $connectionRepository)
    {
        $this->connection_repository = $connectionRepository;
    ...
    /**
     * @return array
     * @throws \ComputerMonitoring\src\computerMonitoring\Exceptions\ValueIsNotPercentage
     */
    public function all()
    {
